  ...
  return (
    <section className="py-24 md:py-32 px-6" ref={sectionRef}>
      <div className="max-w-4xl mx-auto">
        ...
        {/* Quote Card */}
        <div
          className="quote-card max-w-3xl mx-auto mt-20 text-center relative rounded-2xl border border-primary/10 bg-primary/[0.02] p-12 md:p-16 breathing-glow"
          style={{ borderColor: 'rgba(0,255,127,0.15)' }}
        >
          <span className="absolute top-6 left-8 text-6xl text-primary/20 font-serif">"</span>
          <span className="absolute bottom-6 right-8 text-6xl text-primary/20 font-serif">"</span>
