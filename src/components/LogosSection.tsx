    ...
    <section id="logos" className="py-24 md:py-32 px-6" ref={ref}>
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold uppercase tracking-tight mb-4 leading-tight">
          {"Conheça empresas que crescem as vendas online mês a mês com o Águia Digital".split(" ").map((word, i) => (
        ...
        <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.8, duration: 0.6 }} className="text-muted-foreground text-sm md:text-base max-w-4xl mx-auto mb-12">
          Marcas que buscam crescer com clareza, estrutura e resultado escolhem nossa agência como parceira.
        </motion.p>
